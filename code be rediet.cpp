...
the following line of codes intends to conect with Zigbee module in orer to trnafer data from heart sensor for wireless comunicationmandatory amplification of signal from the sensor is n
